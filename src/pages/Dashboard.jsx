    ...
    <div style={{ minHeight:'100vh', background:'var(--bg)', fontFamily:"'Noto Sans TC', sans-serif" }}>
      ...
      <header style={S.header}>
        <div style={S.headerInner}>
          <div style={S.logo}>
            <div style={{...S.logoIcon}}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 123.34 114.65" style={{width:15,height:15}}><path fill="#FFFFFF" d="M117.26,20.95c-1.32-1.48-2.84-2.74-4.52-3.78L122.92,2c-5.39-3.62-12.7-2.19-16.31,3.21-1.87,2.78-2.37,6.07-1.69,9.1-.83-.13-1.67-.24-2.53-.28-3.2-.16-6.31,.41-9.19,1.58L83.11,0c-5.45,3.52-7.02,10.8-3.49,16.25,1.45,2.24,3.55,3.79,5.89,4.63-.17,.18-.36,.35-.52,.54-3.14,3.27-4.38,7.68-5.38,12.09-2.66,7.88-7.43,14.9-13.71,20.27-9.88-3.56-18.34-10.48-23.77-19.61l-.12-.2c-1.3,5.74-1.51,11.83-.42,17.99,.74,4.21,2.04,8.17,3.8,11.84-1.05,.22-2.13,.4-3.21,.54-5.4,.71-10.69,.47-15.72-.62C14.36,59.28,4.68,49.02,1.55,35.53c-.17-.71-.31-1.42-.44-2.13l-.07,.05c-1.22,5.63-1.4,11.6-.33,17.63,2.62,14.86,12.17,26.75,24.73,32.95l.1,.04c-.89,3.29-1.08,6.82-.45,10.4,2.3,13.01,14.72,21.7,27.73,19.4,7.85-1.39,14.13-6.46,17.37-13.13l.12-.25c.69,4.17,.25,8.27-1.09,11.98l.1-.02c2.37-.49,4.73-1.22,7.01-2,6.86-2.35,13.08-5.86,18.54-10.3,5.85,8.51,15.64,14.1,26.75,14.1,.44,0,.88-.01,1.32-.03V34.03h-.06c-.32-4.83-2.25-9.38-5.6-13.08ZM50.57,102.78c-.52,1.5-3.37,1.85-6.35,.8-2.98-1.05-4.97-3.11-4.45-4.6,.53-1.49,3.37-1.85,6.35-.8,2.98,1.05,4.97,3.11,4.45,4.6Zm26.87-32.57c-2.76,.63-5.52-1.12-6.15-3.88-.63-2.77,1.11-5.52,3.88-6.14,2.76-.63,5.52,1.11,6.15,3.87,.63,2.77-1.11,5.52-3.88,6.15Z"/></svg></div>
